    ...
    <div class="row mt-1">
        <div class="col-sm-12">
            <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                ...
                <form id="PerbaikanForm" class="form-horizontal mt-3 mb-4">
                @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" value="{{$gangguan->nama_teras}}" disabled/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-3">Komponen</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" value="{{$gangguan->nama_komponen}}" disabled/>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xl-9">
                            <input type="text" class="form-control" name="tanggal_perbaikan" id="tanggal_perbaikan"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label mt-2 col-sm-3" for="tindakan-3">Tindakan Perbaikan</label>
                        <div class="col-sm-9">
                            <textarea rows="5" class="form-control" name="tindakan" id="tindakan"></textarea>
                        </div>
                    </div>
